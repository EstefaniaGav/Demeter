...
namespace Proyectofinal.Controllers
{
    public class RolsController : Controller
    {
        ...
        public RolsController(ProyectoFinalDemeterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Rols != null ? 
                          ...
                          Problem("Entity set 'ProyectoFinalDemeterContext.Rols'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoFinalDemeterContext.Rols'  is null.");
            }
            var rol = await _context.Rols.FindAsync(id);
            if (rol != null)
            {
